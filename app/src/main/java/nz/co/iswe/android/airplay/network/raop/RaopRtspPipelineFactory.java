...
public class RaopRtspPipelineFactory implements ChannelPipelineFactory {
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		final RaopAudioHandler audioHandler = new RaopAudioHandler(airPlayServer.getExecutorService());
		airPlayServer.attachAudioHandler(audioHandler);
		pipeline.addLast("audio", audioHandler);
